...
const achievementIconMap: Record<string, string> = {
  '🏆': 'trophy.fill',
  '📷': 'camera.fill',
  '🔥': 'shield.fill', // Using shield for champion/streak
  '🎮': 'gamecontroller.fill',
  '⚡': 'bolt.fill', // Using bolt for speed
  '👁️': 'eye.fill', // Using eye for eagle-eye
};
...
export const TrophyRoomScreen: React.FC = () => {
  ...
  const handleRefresh = async () => {
    console.log('🔄 Refreshing Trophy Room stats...');
    try {
      ...
      console.log('✅ Trophy Room refreshed successfully');
    } catch (error) {
      console.error('❌ Failed to refresh Trophy Room:', error);
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Surface style={styles.header} elevation={2}>
        <IconButton 
          ...
          iconColor="white"
        />
        <Text variant="headlineMedium" style={styles.title}>Trophy Room</Text>
        <IconButton 
          icon="refresh" 
          size={24}
